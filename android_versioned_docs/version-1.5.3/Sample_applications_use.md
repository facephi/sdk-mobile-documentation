...
[![Android Repository v.1.5.3](@site/static/img/github_50.png)](https://github.com/facephi/sdk-mobile-samples/tree/1.5.X)<a href="https://github.com/facephi/sdk-mobile-samples/tree/1.5.X"
   rel="nofollow">Android Repository v.1.5.3</a>
