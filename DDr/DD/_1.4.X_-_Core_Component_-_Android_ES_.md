# \[1.4.X\] - Core Component - Android \[ES\]

Este documento hace referencia la **versión 1.4.X** del componente

-   [1.
    Introducción](#id-%5B1.4.X%5D-CoreComponent-Android%5BES%5D-1.Introducción)
    -   [1.1 Requisitos
        mínimos](#id-%5B1.4.X%5D-CoreComponent-Android%5BES%5D-1.1Requisitosmínimos)
-   [2. Integración del
    componente](#id-%5B1.4.X%5D-CoreComponent-Android%5BES%5D-2.Integracióndelcomponente)
    -   [2.1. Añadir repositorio
        privado](#id-%5B1.4.X%5D-CoreComponent-Android%5BES%5D-2.1.Añadirrepositorioprivado)
    -   [2.2. Dependencias requeridas para la
        integración](#id-%5B1.4.X%5D-CoreComponent-Android%5BES%5D-2.2.Dependenciasrequeridasparalaintegración)
-   [3. Inicialización del
    componente](#id-%5B1.4.X%5D-CoreComponent-Android%5BES%5D-3.Inicializacióndelcomponente)
    -   [3.1 Inyección de
        licencias](#id-%5B1.4.X%5D-CoreComponent-Android%5BES%5D-3.1Inyeccióndelicencias)
        -   [a. Obteniendo la licencia a través de un
            servicio](#id-%5B1.4.X%5D-CoreComponent-Android%5BES%5D-a.Obteniendolalicenciaatravésdeunservicio)
        -   [b. Inyectando la licencia como
            String](#id-%5B1.4.X%5D-CoreComponent-Android%5BES%5D-b.InyectandolalicenciacomoString)
    -   [3.2 Habilitar modo
        Debug](#id-%5B1.4.X%5D-CoreComponent-Android%5BES%5D-3.2HabilitarmodoDebug)
-   [4. Iniciar nueva
    operación](#id-%5B1.4.X%5D-CoreComponent-Android%5BES%5D-4.Iniciarnuevaoperación)
    -   [4.1 Tipos de operación
        existentes](#id-%5B1.4.X%5D-CoreComponent-Android%5BES%5D-4.1Tiposdeoperaciónexistentes)
-   [5. Lanzamiento de
    componentes](#id-%5B1.4.X%5D-CoreComponent-Android%5BES%5D-5.Lanzamientodecomponentes)
-   [6. Retorno de
    resultado](#id-%5B1.4.X%5D-CoreComponent-Android%5BES%5D-6.Retornoderesultado)
-   [7. Cierre de
    sesión](#id-%5B1.4.X%5D-CoreComponent-Android%5BES%5D-7.Cierredesesión)
-   [8. Método
    ExtraData](#id-%5B1.4.X%5D-CoreComponent-Android%5BES%5D-8.MétodoExtraData)
-   [9. Personalización de la
    SDK](#id-%5B1.4.X%5D-CoreComponent-Android%5BES%5D-9.PersonalizacióndelaSDK)
    -   [9.1 Colores y
        logo](#id-%5B1.4.X%5D-CoreComponent-Android%5BES%5D-9.1Coloresylogo)
    -   [9.2
        Textos](#id-%5B1.4.X%5D-CoreComponent-Android%5BES%5D-9.2Textos)
    -   [9.3
        Fuente](#id-%5B1.4.X%5D-CoreComponent-Android%5BES%5D-9.3Fuente)
    -   [9.4
        Botones](#id-%5B1.4.X%5D-CoreComponent-Android%5BES%5D-9.4Botones)
...
### 3.2 **Habilitar modo Debug**

Para habilitar los logs en modo *debug* debe incluirse el siguiente
fragmento de código:
...
Es importante recalcar que se debe hacer **nada más crear** el
*sdkController,* **antes** de las inicializaciones.
...
El método **extraData** permite obtener un parámetro tokenizado y
encriptado con la información necesaria para su comunicación con el
**servidor de verificación de Facephi (SDK)**. En estos servicios
existen las herramientas necesarias para deserializar y destokenizar
dichos parámetros para su posterior uso. A continuación se muestra el
código necesario para usar esta funcionalidad:
...
Este método es necesario para la comunicación con el servicio de
**Facephi**, en caso de querer realizar cualquier verificación y de
desear realizar el trackeo de una operación determinada.
...
<img src="attachments/2600206537/2600206543.png" class="image-center"
loading="lazy" data-image-src="attachments/2600206537/2600206543.png"
data-height="111" data-width="387" data-unresolved-comment-count="0"
data-linked-resource-id="2600206543" data-linked-resource-version="1"
...
data-linked-resource-container-id="2600206537"
data-linked-resource-container-version="1"
data-media-id="83731965-ad80-4a9b-bd82-2dd35aea378b"
...
[d886b449-da3f-4670-8f44-19f13fcb3d48.png](attachments/2600206537/2600206543.png)
(image/png)  
