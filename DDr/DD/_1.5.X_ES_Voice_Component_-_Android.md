# \[1.5.X\]\[ES\] Voice Component - Android

Este documento hace referencia la **versión 1.5.X** del componente

-   [0. Requisitos base de SDK
    Mobile](#id-%5B1.5.X%5D%5BES%5DVoiceComponent-Android-0.RequisitosbasedeSDKMobile)
-   [1.
    Introducción](#id-%5B1.5.X%5D%5BES%5DVoiceComponent-Android-1.Introducción)
-   [2. Integración del
    componente](#id-%5B1.5.X%5D%5BES%5DVoiceComponent-Android-2.Integracióndelcomponente)
    -   [2.1. Dependencias requeridas para la
        integración](#id-%5B1.5.X%5D%5BES%5DVoiceComponent-Android-2.1.Dependenciasrequeridasparalaintegración)
-   [3. Iniciar nueva
    operación](#id-%5B1.5.X%5D%5BES%5DVoiceComponent-Android-3.Iniciarnuevaoperación)
-   [4. Controladores
    disponibles](#id-%5B1.5.X%5D%5BES%5DVoiceComponent-Android-4.Controladoresdisponibles)
-   [5. Configuración del
    componente](#id-%5B1.5.X%5D%5BES%5DVoiceComponent-Android-5.Configuracióndelcomponente)
    -   [5.1. Class
        VoiceConfigurationData](#id-%5B1.5.X%5D%5BES%5DVoiceComponent-Android-5.1.ClassVoiceConfigurationData)
        -   [5.1.1.
            phrases](#id-%5B1.5.X%5D%5BES%5DVoiceComponent-Android-5.1.1.phrases)
        -   [5.1.2.
            vibrationEnabled](#id-%5B1.5.X%5D%5BES%5DVoiceComponent-Android-5.1.2.vibrationEnabled)
        -   [5.1.3.
            showTutorial](#id-%5B1.5.X%5D%5BES%5DVoiceComponent-Android-5.1.3.showTutorial)
        -   [5.1.4.
            extractionTimeout](#id-%5B1.5.X%5D%5BES%5DVoiceComponent-Android-5.1.4.extractionTimeout)
-   [6. Uso del
    componente](#id-%5B1.5.X%5D%5BES%5DVoiceComponent-Android-6.Usodelcomponente)
-   [7. Recepción del
    resultado](#id-%5B1.5.X%5D%5BES%5DVoiceComponent-Android-7.Recepcióndelresultado)
    -   [7.1. Recepción de
        errores](#id-%5B1.5.X%5D%5BES%5DVoiceComponent-Android-7.1.Recepcióndeerrores)
    -   [7.2. Recepción de ejecución correcta -
        data](#id-%5B1.5.X%5D%5BES%5DVoiceComponent-Android-7.2.Recepcióndeejecucióncorrecta-data)
        -   [7.2.1
            audios](#id-%5B1.5.X%5D%5BES%5DVoiceComponent-Android-7.2.1audios)
        -   [7.2.2
            tokenizedAudios](#id-%5B1.5.X%5D%5BES%5DVoiceComponent-Android-7.2.2tokenizedAudios)
-   [8. Personalización del
    componente](#id-%5B1.5.X%5D%5BES%5DVoiceComponent-Android-8.Personalizacióndelcomponente)
    -   [8.1
        Textos](#id-%5B1.5.X%5D%5BES%5DVoiceComponent-Android-8.1Textos)
...
***Voice Component***. Éste se encarga de realizar la captura de voz del
...
*VoiceConfigurationData* y pasarlo como parámetro al SDKController
