# \[1.4.X\] - Tracking Component - Android \[ES\]

Este documento hace referencia la **versión 1.4.X** del componente

-   [1.
    Introducción](#id-%5B1.4.X%5D-TrackingComponent-Android%5BES%5D-1.Introducción)
    -   [1.1 Requisitos
        mínimos](#id-%5B1.4.X%5D-TrackingComponent-Android%5BES%5D-1.1Requisitosmínimos)
-   [2. Integración del
    componente](#id-%5B1.4.X%5D-TrackingComponent-Android%5BES%5D-2.Integracióndelcomponente)
    -   [2.1. Dependencias requeridas para la
        integración](#id-%5B1.4.X%5D-TrackingComponent-Android%5BES%5D-2.1.Dependenciasrequeridasparalaintegración)
-   [3. Configuración del
    componente](#id-%5B1.4.X%5D-TrackingComponent-Android%5BES%5D-3.Configuracióndelcomponente)
-   [4. Uso del
    componente](#id-%5B1.4.X%5D-TrackingComponent-Android%5BES%5D-4.Usodelcomponente)
    -   [4.1 Obtener permisos de
        localización](#id-%5B1.4.X%5D-TrackingComponent-Android%5BES%5D-4.1Obtenerpermisosdelocalización)
-   [5. Recepción del
    resultado.](#id-%5B1.4.X%5D-TrackingComponent-Android%5BES%5D-5.Recepcióndelresultado.)
