...
>
> **Para su uso es necesaria una nueva licencia.**

## 1. Introducción

El _Componente_ tratado en el documento actual recibe el nombre de
**_Selphi IAD Component_**.
...
no confiables. Sus principales funcionalidades son las siguientes:
...
**El componente de IAD incluye un parámetro _iad_ en el modelo de datos SelphiResult.**
