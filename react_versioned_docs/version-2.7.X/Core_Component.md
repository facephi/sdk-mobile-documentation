...
All the configuration can be found in the component's *node_modules/@facephi/sdk-core-react-native/src/index.tsx* file.
</div>
...
#### 2.2.7 internalOptions

**type:** *dynamic*

This Record is used to enable or disable security mode, among other functions.

```
mInternalOptions: {"key": "value"}
```
---
